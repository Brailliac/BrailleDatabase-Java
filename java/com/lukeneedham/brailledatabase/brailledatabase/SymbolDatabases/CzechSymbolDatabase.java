...
public class CzechSymbolDatabase extends BrailleSymbolDatabase
{
	...
	private static final BrailleSymbolDataEntry[] allSymbols = {
			...
			new BrailleSymbolDataEntry("ě", LETTER, NOTHING, Cell126), // [126]
			...
			new BrailleSymbolDataEntry("ů", LETTER, NOTHING, Cell23456), // [23456]
			...
			new BrailleSymbolDataEntry(".", R.string.braille_fullstop, PUNCTUATION, SHOW_LETTERS_REP, Cell3),
			...
			new BrailleSymbolDataEntry("”", R.string.braille_closequote, PUNCTUATION, SHOW_LETTERS_REP, Cell2356), // [56] quote sign, also used for second and inch
